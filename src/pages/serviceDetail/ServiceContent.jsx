...
const ServiceContent = ({data}) => {
  return (
    <>
      <div className="rounded-xl overflow-hidden h-6/12">
        <img
          decoding="async"
          width="896"
          height="597"
          src={data.img}
          className="attachment-full size-full wp-image-351"
          alt=""
      ...
      <h1 className="text-5xl font-extrabold my-7">{data.title}</h1>
      <div className="flex gap-2">
        ...
        <div className="flex gap-3 border-e-2 pe-3">
          ...
          <span className="text-gray-400">Service Detail</span>
        </div>
