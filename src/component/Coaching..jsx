...
<div className='bg-primary hover:bg-primary-light transition-colors select-none  p-10'>
    ...
    <div>
    <h1 className='text-xl font-bold my-2 '>Strategic Finance Coaching Program</h1>
    ...
    <div>
    <h1 className='text-xl font-bold my-2 '>Pure Strategic Mastery Coaching Program </h1>
        <p className='text-secondary'>
